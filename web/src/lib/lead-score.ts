...
/**
 * 4-dimension lead scoring for the UniMate AU edu funnel.
 *
 ...
 *
 * Score is shown only to Sam + UniMate via email; never surfaced to students
 * (PRD §6 — avoids perverse incentives + MARA Code ambiguity).
 */
