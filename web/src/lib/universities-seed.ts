...
export const seedUniversities: University[] = [
  {
    ...
    hero_color: "#FDB515",
    courses: [
      { course_name: "Bachelor of Computer Science", level: "undergraduate", field: "IT", duration_months: 36, annual_fee_aud: 54000, ielts_min: 6.5, gpa_min: 7.0, industry_placement: true },
  ...
  },
  {
    ...
    regional: true,
    courses: [
      { course_name: "Bachelor of Computer Science", level: "undergraduate", field: "IT", duration_months: 36, annual_fee_aud: 47000, ielts_min: 6.5, gpa_min: 6.0, industry_placement: true },
  ...
  // ========================================================================
  // P4.5 expansion (2026-04-20): 5 CRICOS-verified non-G8 unis added after
  // web-search dispatch (Atlas + Sonnet + Haiku). CRICOS codes cross-verified.
  // Atlas originally proposed QUT as 00064G — WebSearch corrected to 00213J.
  // Fees + IELTS are indicative 2025 rates; verify against each uni's fee
  // table before production handover (P8 backfill).
  // ========================================================================
  {
    id: "macquarie",
    ...
    hero_color: "#A6192E",
    courses: [
      { course_name: "Bachelor of Information Technology", level: "undergraduate", field: "IT", duration_months: 36, annual_fee_aud: 46500, ielts_min: 6.5, gpa_min: 6.0, industry_placement: true },
      { course_name: "Master of Information Technology", level: "postgraduate", field: "IT", duration_months: 18, annual_fee_aud: 48000, ielts_min: 6.5, gpa_min: 5.5, industry_placement: true },
      { course_name: "Bachelor of Engineering Honours", level: "undergraduate", field: "Engineering", duration_months: 48, annual_fee_aud: 48800, ielts_min: 6.5, gpa_min: 6.5, industry_placement: true },
      { course_name: "Master of Business Analytics", level: "postgraduate", field: "Business", duration_months: 18, annual_fee_aud: 50000, ielts_min: 6.5, gpa_min: 6.0, industry_placement: false },
    ],
  },
  {
    id: "qut",
    ...
    hero_color: "#002748",
    courses: [
      { course_name: "Bachelor of Information Technology", level: "undergraduate", field: "IT", duration_months: 36, annual_fee_aud: 40800, ielts_min: 6.5, gpa_min: 6.0, industry_placement: true },
      { course_name: "Master of Information Technology", level: "postgraduate", field: "IT", duration_months: 24, annual_fee_aud: 41200, ielts_min: 6.5, gpa_min: 5.5, industry_placement: true },
      { course_name: "Bachelor of Engineering Honours", level: "undergraduate", field: "Engineering", duration_months: 48, annual_fee_aud: 42000, ielts_min: 6.5, gpa_min: 6.5, industry_placement: true },
      { course_name: "Bachelor of Business", level: "undergraduate", field: "Business", duration_months: 36, annual_fee_aud: 38400, ielts_min: 6.5, gpa_min: 6.0, industry_placement: false },
    ],
  },
  {
    id: "curtin",
    ...
    regional: true,
    courses: [
      { course_name: "Bachelor of Computing", level: "undergraduate", field: "IT", duration_months: 36, annual_fee_aud: 38500, ielts_min: 6.5, gpa_min: 6.0, industry_placement: true },
      { course_name: "Master of Information Technology", level: "postgraduate", field: "IT", duration_months: 24, annual_fee_aud: 39200, ielts_min: 6.5, gpa_min: 5.5, industry_placement: true },
      { course_name: "Bachelor of Engineering Honours", level: "undergraduate", field: "Engineering", duration_months: 48, annual_fee_aud: 40800, ielts_min: 6.5, gpa_min: 6.5, industry_placement: true },
      { course_name: "Bachelor of Commerce", level: "undergraduate", field: "Business", duration_months: 36, annual_fee_aud: 36800, ielts_min: 6.5, gpa_min: 6.0, industry_placement: false },
    ],
  },
  {
    id: "deakin",
    ...
    regional: true,
    courses: [
      { course_name: "Bachelor of Computer Science", level: "undergraduate", field: "IT", duration_months: 36, annual_fee_aud: 42000, ielts_min: 6.0, gpa_min: 6.0, industry_placement: true },
      { course_name: "Master of Data Science", level: "postgraduate", field: "IT", duration_months: 18, annual_fee_aud: 43500, ielts_min: 6.5, gpa_min: 5.5, industry_placement: true },
      { course_name: "Bachelor of Engineering Honours", level: "undergraduate", field: "Engineering", duration_months: 48, annual_fee_aud: 44000, ielts_min: 6.0, gpa_min: 6.0, industry_placement: true },
      { course_name: "Bachelor of Nursing", level: "undergraduate", field: "Health", duration_months: 36, annual_fee_aud: 40500, ielts_min: 7.0, gpa_min: 6.0, industry_placement: true },
    ],
  },
  {
    id: "griffith",
    ...
    regional: true,
    courses: [
      { course_name: "Bachelor of Information Technology", level: "undergraduate", field: "IT", duration_months: 36, annual_fee_aud: 38900, ielts_min: 6.5, gpa_min: 6.0, industry_placement: true },
      { course_name: "Master of Information Technology", level: "postgraduate", field: "IT", duration_months: 24, annual_fee_aud: 39500, ielts_min: 6.5, gpa_min: 5.5, industry_placement: true },
      { course_name: "Bachelor of Business", level: "undergraduate", field: "Business", duration_months: 36, annual_fee_aud: 37800, ielts_min: 6.5, gpa_min: 6.0, industry_placement: false },
      { course_name: "Bachelor of Nursing", level: "undergraduate", field: "Health", duration_months: 36, annual_fee_aud: 38200, ielts_min: 7.0, gpa_min: 6.0, industry_placement: true },
    ],
  },
];
