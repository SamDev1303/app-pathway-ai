...
// P6 wave 2: SOP generator — lead-gated, versioned, streaming, -safe.
//
...
async function insertDraftWithRetry(
 ...
 log.warn(
 `[pathway-ai.sop] 23505 on attempt ${attempt}/${MAX_ATTEMPTS} — retrying`,
 );
 }
...
export async function POST(req: Request) {
 ...
 {
 error:
 "The SOP generator is briefly unavailable. Please try again — or book a free consultation at our office.",
 },
 { status: 503 },
 );
 }
