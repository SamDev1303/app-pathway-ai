...
export function ChatClient({ mode }: { mode: "drawer" | "page" }) {
 ...
 Deflected — this was a migration question. Book a registered agent:{" "}
 ...
 Outside Atlas's current dataset. A Pathway-AI counsellor can help:{" "}
 <a href="/consult" className="underline">/consult</a>
 </p>
 )}
