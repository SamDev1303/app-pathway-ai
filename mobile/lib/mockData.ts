...
export const advisorPrompts: ChatPrompt[] = [
 ...
 response: "For the UNSW Computer Science pathway, a safe benchmark is IELTS 6.5 overall with no band below 6.0. If your current score is lower, Pathway-AI would usually shortlist pathway-friendly alternatives while planning a retake."
 },
 {
 id: "outcomes-courses",
 label: "Strong graduate outcomes",
 response: "For graduate-outcomes-focused planning, Pathway-AI tends to favour regional study options, nursing, software, cyber, and select business analytics pathways where industry placement, employer networks, and campus employability services stack more cleanly. A registered counsellor handles anything beyond course selection in consultation."
 },
 {
 id: "budget-options",
...
export const admissionsUpdate = {
 ...
 body: "Australian universities in 2026 emphasise genuine-student evidence, English preparedness, and clear academic intent. Strong financial documentation and a clear course logic matter more than ever. A registered counsellor can help you assemble an admissions-ready file."
};
