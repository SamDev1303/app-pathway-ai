...
3. Document region deviation — Supabase project is in `ap-southeast-1` (Singapore) not `ap-southeast-2` (Sydney) as PRD §6 required. Sam overrode after Koda flagged. `planning/atlas-ai/DEVIATIONS.md` DEV-001 records 4 downstream obligations.
...
- `planning/atlas-ai/DEVIATIONS.md` — DEV-001 full record
- `PRD.md` §4 + §6 — where deviation is inline-noted
- `planning/atlas-ai/P1-HANDOFF.md` — original handoff (some steps superseded by Management API approach)
