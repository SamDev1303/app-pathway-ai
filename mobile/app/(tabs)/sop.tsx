...
export default function SopScreen() {
 ...
 setError(
 "Our SOP generator is briefly unavailable. Try again in a moment, or book a free consultation at our office.",
 );
 haptics.error();
 } finally {
 setGenerating(false);
 ...
 multiline
 hint="Write your short and long-term goals. Pathway-AI will turn this into the closing arc."
 />
 ) : null}
 ...
 Drafting your SOP with -trained guidance…
 </Text>
 </View>
 ) : error ? (
