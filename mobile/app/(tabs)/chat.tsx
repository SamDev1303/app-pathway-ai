...
export default function ChatScreen() {
  ...
  const ask = async (question: string) => {
    ...
    try {
      ...
      animateResponse(assistantId, response || "I couldn't reach a clear answer just now. Try a MARA-specific question or book a free consultation at our Liverpool office.");
    } catch (err) {
      setWaiting(false);
      setStreamingId(null);
      const fallback =
        "Our AI advisor is briefly unavailable. Please book a free consultation at our Liverpool office on +61 2 8000 1234 — we'll answer within the hour.";
      setMessages((current) =>
      ...
      >
            ...
            <View style={{ flexDirection: "row", alignItems: "center", gap: 16 }}>
              ...
              <View style={{ flex: 1 }}>
                ...
                <Text style={[typography.body, { marginTop: 8, fontSize: 14, lineHeight: 22, color: "rgba(255,255,255,0.92)" }]}>
                  Ask a migration-study question. Powered by MARA-trained guidance.
                </Text>
              </View>
            </View>
          </View>
        ...
        >
          ...
          <Text style={[typography.body, { textAlign: "center", fontSize: 12, color: "#667199" }]}>
            Not legal advice — book a free consultation at our Liverpool office.
          </Text>
        </View>
      </KeyboardAvoidingView>
    </SafeAreaView>
