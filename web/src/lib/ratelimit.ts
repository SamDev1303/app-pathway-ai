...
export const RATE_LIMIT_MESSAGE =
 "You've hit today's usage cap for the free AI advisor. Pathway-AI's registered agents can take it from here — book a free consult: /consult";
...
export const SOP_RATE_LIMIT_MESSAGE =
 "You've hit today's SOP regeneration cap. A registered Pathway-AI agent can review your draft with you — book a free consult: /consult";
