...
export const metadata: Metadata = {
  title: "AI Advisor — Atlas AI",
  description:
    "Ask Atlas AI about CRICOS-registered Australian university courses, IELTS, fees, and intakes. Educational information only — not migration advice.",
};
