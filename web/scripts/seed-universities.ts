#!/usr/bin/env tsx
/**
 * Pathway-AI — P1 universities seed script
 *
...
function loadEnvLocal() {
 ...
 throw new Error(`Missing ${envPath}. Populate Supabase keys first (see planning/pathway-ai/P1-HANDOFF.md)`);
 }
