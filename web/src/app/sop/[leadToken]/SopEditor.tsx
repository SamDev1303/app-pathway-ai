...
export function SopEditor({ lead, initialDraft, initialHistory }: Props) {
 ...
 Academic SOP only — not migration advice. Your registered
 Pathway-AI agent reviews the final version before submission.
 </p>
 </header>
...
function BannerView({ banner }: { banner: NonNullable<Banner> }) {
 ...
 registered Pathway-AI agent can review your draft with you &mdash;{" "}
