...
export const metadata = {
  title: "Book a consultation — Atlas AI",
  description:
    "Book a free consultation with a MARA-registered migration agent at UniMate Pty Ltd, Liverpool NSW.",
};
    ...
    <main className="min-h-screen bg-[var(--color-bg)] text-[var(--color-ink)]">
      <div className="mx-auto max-w-2xl px-6 py-24">
        ...
        <p className="mt-10 text-xs text-[var(--color-ink)]/55 italic leading-relaxed">
          ...
          Only MARA-registered agents may provide it. Atlas AI does not, and
