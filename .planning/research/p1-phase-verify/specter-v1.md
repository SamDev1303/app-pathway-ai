...
|10| PASS | DEV-001 documented in `planning/atlas-ai/DEVIATIONS.md`: region `ap-southeast-1` vs required `ap-southeast-2` with four downstream obligations. |
...
- Region deviation (DEV-001) requires APP 8 disclosure, UniMate client disclosure, MARA sign‑off, and APP 13 SOP updates before production.
