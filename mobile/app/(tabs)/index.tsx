...
export default function HomeScreen() {
 ...
 Read how Pathway-AI frames this
 </Text>
 ...
 Pathway-AI folds your study ambition, budget comfort, IELTS reality, and graduate-outcomes focus into one narrative-friendly recommendation flow. The point is not more choices. The point is better choices.
 </Text>
 </View>
 </EditorialCard>
 </View>
